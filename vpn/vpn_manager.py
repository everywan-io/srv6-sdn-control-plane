...
if __name__ == '__main__':
    ...
    name = 'research'
    interfaces = [
        ('0.0.0.1', 'ads1-eth3', 'fc00::10:0:0/96', 'fc00::10:0:1/96'),
        ('0.0.0.2', 'ads2-eth3', 'fc00::30:0:0/96', 'fc00::30:0:1/96')
    ]
    tenantid = 10
    ...
    name = 'research'
    interfaces = [
        ('0.0.0.1', 'ads1-eth4', 'fc00::20:0:0/96', 'fc00::20:0:1/96'),
        ('0.0.0.3', 'sur1-eth3', 'fc00::40:0:0/96', 'fc00::40:0:1/96'),
        ('0.0.0.3', 'sur1-eth4', 'fc00::50:0:0/96', 'fc00::50:0:1/96')
    ]
    tenantid = 20
    intent = VPNIntent(name, interfaces, tenantid)
    create_vpn(intent)
    ...
    name = 'research'
    interfaces = [
        ('0.0.0.1', 'ads1-eth4', 'fc00::100:0:0/96', 'fc00::100:0:1/96'),
        ('0.0.0.2', 'ads2-eth4', 'fc00::200:0:0/96', 'fc00::200:0:1/96'),
        ('0.0.0.3', 'sur1-eth4', 'fc00::300:0:0/96', 'fc00::300:0:1/96')
    ]
    tenantid = 20
    intent = VPNIntent(name, interfaces, tenantid)
    create_vpn(intent)
    ...
    # Add interface
    name = 'research'
    interface = ('0.0.0.1', 'ads1-eth4', 'fc00::400:0:0/96', 'fc00::400:0:1/96')
    tenantid = 10
